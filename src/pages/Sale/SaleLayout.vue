<template>
  <q-page class="q-pa-lg">
    <div class="row justify-between items-center">
      <TitleH4 :title="$t('venda')" :caption="$t('vendaCaption')" class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12"/>
...
const isIndex = computed(() => router.currentRoute.value.name === 'sale')
